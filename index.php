...
<body <?php body_class(); ?> data-spy="scroll" data-target="#ftco-navbar-spy" data-offset="0">
...
<div class="site-wrap">
    ...
    <div class="main-wrap " id="section-home">
        ...
        <div class="cover_1 overlay bg-slant-white bg-light">
            <div class="img_bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/slider-1.jpg);" data-stellar-background-ratio="0.5">
                <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="ftco-46">
                        <div class="ftco-46-row d-flex flex-column flex-lg-row">
                            <div class="ftco-46-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/img_1.jpg);"></div>
                            ...
                            <div class="ftco-46-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/img_2.jpg);"></div>
                        </div>
                        ...
                        <div class="ftco-46-row d-flex flex-column flex-lg-row">
                            ...
                            <div class="ftco-46-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/img_3.jpg);"></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portfolio-grid portfolio-gallery grid-4 gutter">
                            ...
                            <div class="portfolio-item cat2 cat3 cat4">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img1.jpg" class="portfolio-image popup-gallery" title="Bread">
                            ...
                            <div class="portfolio-item cat2 cat3 cat4">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img9.jpg" class="portfolio-image popup-gallery" title="Bread">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/img9.jpg" alt=""/>
                                    <div class="portfolio-hover-title">
                                        <div class="portfolio-content">
                                            <h4>Branding</h4>
                                            <div class="portfolio-category">
                            ...
                            <div class="portfolio-item cat1 cat2 cat3">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img2.jpg" class="portfolio-image popup-gallery" title="Design">
                            ...
                            <div class="portfolio-item cat1 cat4">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img10.jpg" class="portfolio-image popup-gallery" title="Photography">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/img10.jpg" alt=""/>
                                    <div class="portfolio-hover-title">
                                        <div class="portfolio-content">
                                            <h4>Photography</h4>
                                            <div class="portfolio-category">
                            ...
                            <div class="portfolio-item cat3 cat5">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img4.jpg" class="portfolio-image popup-gallery" title="Marketing">
                            ...
                            <div class="portfolio-item cat4 cat5">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img5.jpg" class="portfolio-image popup-gallery" title="Web Desgin">
                            ...
                            <div class="portfolio-item cat2 cat3">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img7.jpg" class="portfolio-image popup-gallery" title="Media">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/img7.jpg" alt=""/>
                                    <div class="portfolio-hover-title">
                                        <div class="portfolio-content">
                                            <h4>Media</h4>
                                            <div class="portfolio-category">
                            ...
                            <div class="portfolio-item cat3 cat4 cat5">
                                <a href="<?php echo get_template_directory_uri(); ?>/images/img6.jpg" class="portfolio-image popup-gallery" title="Portfolio">
                ...
                <div class="row">
                        ...
                        <div class="ftco-38">
                            <div class="ftco-38-img">
                                <div class="ftco-38-header">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/chef_1.jpg"
                    ...
                    <div class="col-md-6 pl-md-5 text-center mb-5">
                        <div class="ftco-38">
                            <div class="ftco-38-img">
                                <div class="ftco-38-header">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/chef_2.jpg"
                                         alt="Free Website Template for Restaurants by Free-Template.co">
                            ...
                            <div class="tab-pane fade show active" id="pills-breakfast" role="tabpanel"
                                ...
                                <div class="d-block d-md-flex menu-food-item">
                                    ...
                                    <div class="text order-1 mb-3">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/img_1.jpg"
                                             alt="Free Website Template for Restaurants by Free-Template.co">
                                ...
                                <div class="d-block d-md-flex menu-food-item">
                                    <div class="text order-1 mb-3">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/img_2.jpg"
                                             alt="Free Website Template for Restaurants by Free-Template.co">
                                ...
                                <div class="d-block d-md-flex menu-food-item">
                                    <div class="text order-1 mb-3">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/img_3.jpg"
                                             alt="Free Website Template for Restaurants by Free-Template.co">
        ...
        <div class="section bg-white services-section" data-aos="fade-up">
            <div class="container">
                ...
                <?php   
                                    // Reservation Part  ********************************************
                                    get_template_part('page-template/reservation');
                ?>
                        ...
                        <div class="owl-carousel home-slider-loop-false">
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/person_1.jpg" alt="Image placeholder" class="mb-3">
                                        <h4>Maxim Smith</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/person_2.jpg" alt="Image placeholder" class="mb-3">
                                        <h4>Geert Green</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/person_3.jpg" alt="Image placeholder" class="mb-3">
                                        <h4>Dennis Roman</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>
